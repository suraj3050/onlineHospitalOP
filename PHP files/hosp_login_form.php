...
<div class="container">
  <form action="hosp_login.php" method="post">
      ...
      <div class="col-75">
        <input type="email" id="email" name="email" placeholder="Your E-Mail.."required autofocus>
      </div>
    </div>
	<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="password" id="pwd" name="pwd" placeholder="Your your Password.."required>
      </div>
    </div>
