...
<div class="container">
  <form action="patient_reg_insertdb.php" method="post">
    <div class="row">
      <div class="col-25">
        <label for="pname">User-Name</label>
      </div>
      <div class="col-75">
        <input type="text" id="pname" name="pname" placeholder="Your Name.." required autofocus>
      </div>
    </div>
				<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="email" id="pemail" name="pemail" placeholder="Your E-Mail.."required>
      </div>
    </div>
	<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="password" id="ppwd" name="ppwd" placeholder="Your your Password.."required>
      </div>
    </div>
	<div class="row">
      <div class="col-25">
        <label for="pcpwd">Confirm-Password</label>
      </div>
      <div class="col-75">
        <input type="password" id="pcpwd" name="pcpwd" placeholder="Confirm-Password.."required>
      </div>
    </div>
	<div class="row">
