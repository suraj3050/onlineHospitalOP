...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">Online Hospital OP</h1>
  <p class="w3-xlarge">Now getting an OPD appointment, lab reports and blood availability in any hospital has become online & easy</p>
  <button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" onclick="window.location = 'hosp_login_form.php';">Hospital Admin </button>
  
  <button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" onclick="window.location = 'patient_login_form.php';">User LogIn</button>
  
	<button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" onclick="window.location = 'doctor_login_form.php';">Doctor LogIn</button>
 </header>
